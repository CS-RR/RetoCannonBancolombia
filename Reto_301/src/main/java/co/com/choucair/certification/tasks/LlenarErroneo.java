...
public class LlenarErroneo implements Task {

    private final List <CanonDatos> canonDatos;

    public LlenarErroneo(List<CanonDatos> canonDatos) {
        this.canonDatos = canonDatos;
    }

    public static LlenarErroneo formulario(List<CanonDatos> canonDatosList) {
        return Tasks.instrumented(LlenarErroneo.class,canonDatosList);
    }
